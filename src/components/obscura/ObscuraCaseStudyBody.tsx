...
const obMediaCaption = "site-gallery-caption case-study-media-caption-mt text-left text-ink-muted";
...
function IntentPrincipleRow({
    ...
    imageSrc != null && imageAlt != null ? (
      ...
      <div className="absolute inset-0 min-h-0" role="img" aria-label={imageAria ?? ""}>
        <ImagePlaceholder
          ...
          fullBleed
          className="border-0 bg-gradient-to-br from-paper-sunken to-paper-sunken"
        />
      </div>
    );
  ...
  return (
    <Reveal delay={delay}>
      <div className="min-h-0 overflow-hidden border border-ink/[0.1] bg-ink/[0.04]">
        <div className="flex min-h-0 flex-col">
          <div className="px-10 pt-10 md:px-14 md:pt-14">
            <div className="relative aspect-square w-full overflow-hidden bg-paper-sunken">
              {visual}
            </div>
          </div>
...
function ObscuraVideo({
    ...
    return (
        <div
            className={cn(
                "relative overflow-hidden border border-ink/[0.1] group",
                objectFit === "contain" && "bg-paper-sunken"
            )}
            onMouseEnter={() => {
                if (videoRef.current) {
        ...
        >
            ...
            <div className="absolute bottom-3 left-3 flex items-center gap-2">
                <span className="type-caption text-white bg-black/40 px-2 py-1">
                    {label}
                </span>
            </div>
...
export function ObscuraCaseStudyBody() {
    ...
    return (
        <LightboxProvider>
                ...
                <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
                    {/* Wayne's photograph reads as ink printed into the paper rather than a
                        picture floating on top of it — multiply keeps the paper grain showing
                        through the highlights instead of flattening them to grey. */}
                    <div className="absolute inset-0">
                        <img
                            src="/assets/obscura/wayne_1946.avif"
                            alt=""
                            className="w-full h-full object-cover opacity-[0.32] mix-blend-multiply"
                            draggable={false}
                        />
                        <div className="absolute inset-0 bg-gradient-to-b from-[var(--paper)] via-transparent to-[var(--paper)]" />
                        {/* Vignette */}
                        <div className="absolute inset-0" style={{
                            background: "radial-gradient(ellipse at center, transparent 40%, var(--paper) 100%)"
                        }} />
                    </div>
                    ...
                    <div className={cn("relative z-10 w-full py-32 md:py-40 text-left", obscuraSectionShell)}>
                        ...
                        <Reveal>
                            <a
                                ...
                                className="site-label text-amber-800/80 hover:text-amber-900 transition-colors duration-150 inline-flex items-center gap-1.5 text-left"
                            >
                        ...
                        <HeroTextAnimation variant="split-chars" className="type-display-black text-ink text-left mix-blend-multiply">
                            OBSCURA
                        </HeroTextAnimation>
                        ...
                        <Reveal delay={0.4}>
                            <div className={cn("flex flex-wrap justify-start gap-x-10 gap-y-6", obBody, "text-ink-muted")}>
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Role</span>
                                    Lead Interaction Designer, Prototyper, &amp; Developer
                                </div>
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Team</span>
                                    Asa Symons, Caiya Wiltshire, Nick Hallin
                                </div>
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Client</span>
                                    <a
                                        href="https://mohai.org/event/transpacific-photography-and-the-obscura-project-post-world-war-ii-life-in-japan/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-ink-muted underline underline-offset-2 decoration-neutral-500/60 hover:text-amber-900 hover:decoration-amber-800/50 transition-colors"
                                    >
                                        MOHAI
                                    </a>
                                </div>
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Date</span>
                                    September 13, 2025
                                </div>
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Key Tech</span>
                ...
                <section className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    <div className="case-study-prose-stack">
                        <Reveal>
                            <p className={cn(obBody, "text-ink-muted")}>
                ...
                <section id="overview" className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            <h2 className="site-chapter-heading case-study-heading-trail-mb text-ink">
                                Experience Overview
                            </h2>
                            <p className={cn(obBody, "text-ink-muted")}>
                ...
                <section className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="overflow-hidden border border-ink/[0.1] bg-paper-sunken">
                            <video
                ...
                <section id="intent" className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    ...
                    <div className="case-study-prose-stack flex flex-col">
                        ...
                        >
                            <h3 className="site-label text-amber-800/80 text-left">
                ...
                <section id="blueprint" className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    ...
                    <Reveal>
                        <div className="case-study-block-gap w-full border border-ink/[0.1] bg-ink/[0.04] px-6 py-10 text-center md:px-10 md:py-12">
                            <p className={obBody}>
                                <span className="text-amber-800">How might we</span>{" "}
                    ...
                    <Reveal>
                        <div className="case-study-block-gap">
                            <span className="site-label text-amber-800/70 case-study-heading-trail-mb block text-left">
                                Research: Finding the Human Narrative
                            </span>
                            <p className={cn(obBody, "text-ink-muted w-full min-w-0 text-left")}>
                    ...
                    <Reveal>
                        <div className="case-study-block-gap case-study-grid-gap-dense grid grid-cols-1 md:grid-cols-2">
                            <div className="overflow-hidden border border-ink/[0.1] aspect-[4/3]">
                                <LightboxImage
                    ...
                    <div className="case-study-block-gap case-study-prose-stack flex flex-col">
                        <Reveal>
                            <blockquote className="border-l-2 border-amber-800/25 pl-6 py-2">
                                <p className={cn(obBody, "case-study-heading-trail-mb text-ink-secondary")}>
                                ...
                                <cite className={cn(obBody, "text-ink-subtle not-italic")}>
                    ...
                    <Reveal>
                        <div className="case-study-block-gap w-full min-w-0">
                            ...
                            {blueprintThemeCards.map(({ title, body, Icon }) => (
                                <div
                                    key={title}
                                    className="case-study-grid-gap-tight flex items-center border border-ink/[0.1] bg-ink/[0.04] p-5 md:p-6"
                                >
                                    <div
                                        className="flex size-11 shrink-0 items-center justify-center border border-amber-800/20 bg-amber-900/[0.06] text-amber-800 md:size-12"
                                        aria-hidden
                                    >
                                        <Icon className="size-[1.35rem] md:size-6" strokeWidth={1.65} />
                                    </div>
                                    <div className="min-w-0 flex-1">
                                        <h3 className="site-label case-study-tight-trail-mb text-left text-amber-800/70">
                                            {title}
                                        </h3>
                                        <p className={cn(obBody, "m-0 text-left text-ink-secondary")}>{body}</p>
                                    </div>
                                </div>
                            ))}
                            </div>
                        ...
                        <div className="case-study-block-gap">
                            ...
                            <div className="case-study-grid-gap-dense grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5">
                                {(
                                    ...
                                    <div
                                        key={word}
                                        className="flex min-h-[5rem] items-center justify-center border border-ink/[0.1] bg-ink/[0.04] px-3 py-4 text-center md:min-h-[5.5rem] md:py-5"
                                    >
                                        <span className="type-caption text-ink-secondary text-center">
                                            {word}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div>
                            ...
                            <div className="case-study-grid-gap-dense grid grid-cols-2 md:grid-cols-3">
                                {[
                                    ...
                                    <div key={sketch.alt} className="overflow-hidden border border-ink/[0.1]">
                                        <LightboxImage
                                            src={sketch.src}
                                            alt={sketch.alt}
                    ...
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            ...
                            <p className={cn(obBody, "text-ink-muted w-full min-w-0")}>
                                Because we were creating an asynchronous experience dictated by attention, standard wireframes failed. I used high-fidelity storyboarding to map the emotional journey:
                            </p>
                            <ol className={cn(obBody, "mt-4 list-decimal space-y-2 pl-5 text-ink-muted marker:text-ink-subtle")}>
                                <li className="pl-1">
                                    The moment a visitor first sees the audience projection and grows curious
                                </li>
                                <li className="pl-1">
                                    The transition from spectator to participant as they enter the booth
                                </li>
                                <li className="pl-1">
                                    The private act of looking
                                </li>
                                <li className="pl-1">
                                    The &ldquo;Souvenir Moment&rdquo; at the exit &mdash; where a printed photo-strip gives them something physical to carry out and compare with others
                                </li>
                            </ol>
                        </div>
                    </Reveal>
                    ...
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            <div className="overflow-hidden border border-ink/[0.1]">
                                <LightboxImage
                ...
                <section id="prototyping" className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    ...
                    <Reveal>
                        <div className="case-study-block-gap case-study-intra-stack flex w-full min-w-0 flex-col">
                            <div className="w-full min-w-0 border border-ink/[0.1] bg-ink/[0.04] p-8 md:p-10">
                    ...
                    <Reveal>
                        <div className="case-study-block-gap w-full min-w-0">
                            ...
                            <p className={cn(obBody, "text-ink-muted w-full")}>
                    ...
                    <Reveal>
                        ...
                        <div className="case-study-subsection-gap case-study-grid-gap-tight grid grid-cols-1 md:grid-cols-[minmax(0,1.55fr)_minmax(0,0.88fr)] md:grid-rows-[auto_auto] md:items-stretch">
                            <div className="relative min-h-0 overflow-hidden border border-ink/[0.1] aspect-[4/3] md:row-span-2 md:aspect-auto md:h-full md:min-h-[min(52vw,380px)]">
                                <LightboxImage
                            ...
                            <div className="min-h-0 overflow-hidden border border-ink/[0.1] aspect-[4/3] md:aspect-[5/4]">
                                <LightboxImage
                            ...
                            <div className="flex min-h-[148px] items-center justify-center overflow-hidden border border-ink/[0.1] bg-paper-sunken p-2 md:min-h-[168px]">
                                <LightboxImage
                ...
                <section className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="case-study-block-gap">
                            <div className="case-study-subsection-gap overflow-hidden border border-ink/[0.1] aspect-video bg-paper-sunken">
                                <LightboxImage
                    ...
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            ...
                            <p className={cn(obBody, "text-ink-muted max-w-[600px]")}>
                ...
                <section id="exhibition" className={cn(obscuraSectionShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div>
                            ...
                            <div className="case-study-prose-stack flex w-full min-w-0 flex-col">
                                <p className={cn(obBody, "m-0 text-left text-ink-muted")}>
                    ...
                    <Reveal className="case-study-media-caption-mt">
                        ...
                        */}
                        <div className="case-study-grid-gap-dense grid w-full min-w-0 grid-cols-1 items-start md:grid-cols-2">
                            <div className="min-w-0 overflow-hidden border border-ink/[0.1] bg-paper-sunken">
                                <LightboxImage
                ...
                <section id="reflection" className="relative case-study-section-y overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-paper-sunken to-[var(--paper)]" />
                    <div className={cn("relative", obscuraSectionShell)}>
                        <Reveal>
                            <div className="case-study-hero-bump-mb">
                                <h2 className="site-chapter-heading case-study-heading-trail-mb text-ink">Reflection</h2>
                            </div>
                        </Reveal>
                        <Reveal delay={0.05}>
                            <div className="w-full overflow-hidden border border-ink/[0.1] bg-paper-sunken">
                                <LightboxImage
                        ...
                        <Reveal delay={0.15} className="case-study-media-caption-mt">
                            <blockquote className="w-full min-w-0 border-l-2 border-amber-800/25 py-2 pl-6">
                                <p className={cn(obBody, "case-study-heading-trail-mb text-ink-secondary")}>
                        ...
                        <Reveal delay={0.3} className="case-study-media-caption-mt">
                            <div className="w-full text-left">
                                <p className="site-label mb-6 text-amber-800/70">
                                    Gratitude
                                </p>
                                <div className="flex flex-col gap-5 md:gap-6">
                                    <div>
                                        <p className="mb-1.5 text-sm font-medium text-ink-secondary">Wong Family</p>
                                        <p className={cn(obBody, "text-ink-muted")}>
                                            Wayne Wong, Curtis Wong, Anne Rudden
                                        </p>
                                    </div>
                                    <div>
                                        <p className="mb-1.5 text-sm font-medium text-ink-secondary">Teammates</p>
                                        <p className={cn(obBody, "text-ink-muted")}>
                                            Asa Symons, Caiya Wiltshire, Nick Hallin
                                        </p>
                                    </div>
                                    <div>
                                        <p className="mb-1.5 text-sm font-medium text-ink-secondary">MOHAI</p>
                                        <p className={cn(obBody, "text-ink-muted")}>
                                            Leonard Garfield, Devorah Romanek, Sorana Nance, Rachel Spence
                                        </p>
                                    </div>
                                    <div>
                                        <p className="mb-1.5 text-sm font-medium text-ink-secondary">UW</p>
                                        <p className={cn(obBody, "text-ink-muted")}>
                                            Ana Pinto Da Silva, Matt Bartels, Dukes Wooters, Axel Roesler, Kristin N Dew, John Zošák
                                        </p>
                                    </div>
                                    <div>
                                        <p className="mb-1.5 text-sm font-medium text-ink-secondary">External Advisors</p>
                                        <p className={cn(obBody, "text-ink-muted")}>

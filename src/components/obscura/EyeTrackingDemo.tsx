    ...
    <div className={cn("w-full space-y-4", className)}>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="relative flex h-[200px] w-full items-center justify-center overflow-hidden border border-ink/[0.1] bg-paper-sunken">
            <div
              ref={erraticBlobRef}
          ...
          <span className="type-caption-medium uppercase text-ink-muted text-left">

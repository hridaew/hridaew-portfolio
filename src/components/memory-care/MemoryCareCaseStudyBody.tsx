...
const mcesExternalLinkClass =
    "underline decoration-ink/[0.385] underline-offset-[0.15em] transition-colors hover:decoration-ink/[0.77] focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/[0.32] focus-visible:ring-offset-2 focus-visible:ring-offset-background";

export function MemoryCareCaseStudyBody() {
    return (
        <LightboxProvider>
                {/* ─── HERO ─── */}
                <section id="hero" className="relative pt-32 pb-20 md:pt-40 md:pb-28">
                    ...
                    <div className="relative w-full min-w-0 text-left">
                        <Reveal>
                            <div className="case-study-hero-bump-mb inline-flex items-center gap-2 rounded-full border border-ink/[0.08] bg-ink/[0.02] px-4 py-1.5">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-ink-subtle">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                                <span className="site-label text-left text-ink-secondary">
                        ...
                        <HeroTextAnimation
                            variant="typewriter"
                            className="type-h1 case-study-hero-title-mb-loose text-left text-ink"
                        >
                            Memory Care Experience Station
                        </HeroTextAnimation>

                        <Reveal delay={0.2}>
                            <p className="site-body case-study-hero-lead-mb text-left text-ink-muted">
                                A multi-sensory pilot program enabling immersive engagement for residents with sensory deprivation.
                            </p>
                        </Reveal>

                        <Reveal delay={0.3}>
                            <div className="flex flex-wrap justify-start gap-x-8 gap-y-3 site-body text-ink-muted">
                                <div>
                                ...
                                <div>
                                    <span className="site-label text-ink-subtle case-study-meta-line-mb block text-left">Timeline</span>
                ...
                <section className={cn(mcesShell, "pb-20 md:pb-28")}>
                    <Reveal>
                        <div className="relative w-full min-w-0 aspect-video overflow-hidden rounded-2xl border border-ink/[0.08] shadow-e3">
                            <iframe
                ...
                <section className={cn(mcesShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="flex flex-col gap-5 text-left md:gap-6">
                            <p className="site-body font-medium text-ink">
                ...
                <section id="connection" className={cn(mcesShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="case-study-subsection-gap flex flex-col case-study-heading-trail-gap">
                            <span className="site-label text-ink-subtle text-left">
                                01
                            </span>
                            <h2 className="site-chapter-heading text-left text-ink">
                                Prototyping Connection
                            </h2>
                            <p className="site-body text-left text-ink-muted">
                    ...
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            <span className="site-label text-ink-subtle case-study-heading-trail-mb block text-left">
                                The Insight
                            </span>
                    ...
                    {/* Validation */}
                    <Reveal>
                        <div className="bg-card rounded-2xl border border-ink/[0.08] p-8 md:p-10">
                            <span className="site-label text-ink-subtle case-study-heading-trail-mb block text-left">
                                The Validation
                            </span>
                            <p className="site-body text-ink-muted text-left">
                ...
                <section id="accessibility" className={cn(mcesShell, "case-study-section-y-b")}>
                    ...
                    <Reveal className="case-study-block-gap">
                        <div className="case-study-grid-gap-dense grid grid-cols-1 items-start md:grid-cols-2">
                            <div className="rounded-xl overflow-hidden border border-ink/[0.08] h-fit">
                                <LightboxImage
                    ...
                    <Reveal>
                        <div className="case-study-subsection-gap">
                            ...
                            <p className="site-body case-study-hero-bump-mb text-left text-ink-muted">
                    ...
                    <Reveal>
                        <div className="case-study-grid-gap flex flex-col">
                            <div className="bg-card rounded-xl border border-ink/[0.08] p-6">
                                <span className="site-label text-ink-subtle case-study-heading-trail-mb block text-left">
                                    The Pivot
                                </span>
                                <p className="site-body text-ink-muted text-left">
                ...
                <section id="caregiver" className={cn(mcesShell, "case-study-section-y-b")}>
                    ...
                    <Reveal className="case-study-block-gap">
                        <div className="w-full min-w-0 overflow-hidden rounded-xl border border-ink/[0.08]">
                            <LightboxImage
                    ...
                    <Reveal>
                        <div className="case-study-grid-gap case-study-block-gap flex w-full min-w-0 flex-col">
                            <div className="w-full min-w-0 rounded-xl border border-ink/[0.08] bg-card p-6">
                                <span className="site-label text-ink-subtle case-study-heading-trail-mb block text-left">
                    ...
                    <div className={cn("relative", mcesShell)}>
                        <Reveal>
                            <div className="case-study-grid-gap-wide grid grid-cols-1 text-center md:grid-cols-3">
                                <div>
                                    <p className="type-h1 case-study-tight-trail-mb text-left text-ink">
                                        194+
                                    </p>
                                    <p className="site-body text-ink-muted text-left">
                ...
                <section className={cn(mcesShell, "case-study-section-y-b")}>
                    <Reveal>
                        <div className="case-study-grid-gap-wide flex w-full min-w-0 flex-col">
                            <div className="case-study-prose-stack flex w-full min-w-0 flex-col rounded-2xl border border-ink/[0.08] bg-card p-8 md:p-10">
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="text-ink-subtle">
                                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                                </svg>
                                <p className="site-body text-left text-ink">
                                ...
                                <p className="site-body text-left text-ink-subtle">
                ...
                <section className={cn(mcesShell, "pb-20 md:pb-28")}>
                    <Reveal>
                        <div className="bg-card rounded-2xl border border-ink/[0.08] p-8 md:p-10">
                            <h3 className="site-label case-study-panel-heading-mb text-left text-ink-subtle">
                                Recognition
                            </h3>
                            <div className="case-study-prose-stack flex flex-col">
                                <div className="case-study-grid-gap-dense flex items-start">
                                    <span
                                        aria-hidden
                                        className="flex h-[1.5rem] w-4 shrink-0 items-center justify-center leading-none text-ink-subtle"
                                    >
                                        &#9733;
                                    </span>
                                    <p className="site-body text-ink text-left">
                ...
                <section className={cn(mcesShell, "pb-20 md:pb-28")}>
                    <Reveal>
                        <div className="rounded-2xl border border-ink/[0.08] bg-card p-8 md:p-10">
                            <p className="site-body text-left text-ink-muted italic">
                ...
                <section id="reflection" className={cn(mcesShell, "pb-32 md:pb-40")}>
                    <Reveal>
                        <h2 className="site-chapter-heading case-study-hero-bump-mb text-left text-ink">
                            Reflection
                        </h2>
                    </Reveal>
                    <Reveal delay={0.1}>
